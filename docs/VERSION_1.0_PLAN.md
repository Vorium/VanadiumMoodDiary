...
| 阶段 | 时间 | 动作 |
|------|------|------|
| M0 当前 | 2026-08-07 | v0.30.0+85 R95 sub-spec 7 + sub-spec 8 完成 (P2 + P3 不需外部资源任务 + 22 commit, baseline 1951 → 2019 pass, +68 tests, 0 pre-existing fail, 18 守门员全绿, 0 analyzer error) |
...
| M3.5 R95 阶段 4 | 2026-08-13 ✅ | **R95 sub-spec 8 完成** (task 17/18/19/45/46/48/56-67, +11 tests 2008 → 2019, 4 group 重构 + 5→3 步 + tooltip/chip/visual hint + late final 改 immutable) |
