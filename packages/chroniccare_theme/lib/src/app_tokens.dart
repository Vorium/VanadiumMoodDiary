...
// 让老 import `package:chroniccare_theme/chroniccare_theme.dart` 的 caller
...
/// - v0.31 R4 · Apple Health redesign Phase 1 Task 1.4: 1 Apple curve 转发
///   (curveSpring, spec §3.4.3 Spring 物理模型) + R32 P1-7 删 curveAppleSheet/Drawer
///   死代码 (Material.showModalBottomSheet 不暴露 transitionAnimationController)
///   + 现有 curve 全部自动跟随 AppMotion 新值 (老 caller 不动)。注意 AppMotion.durNormal /
...
class AppTokens {
  ...
  // R32 (P1-7 死代码清理): 删 curveAppleSheet/Drawer facade 转发
