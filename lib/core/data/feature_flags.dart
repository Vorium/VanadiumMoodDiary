...
// 同步改 _prodBootReceiverEnabled = true → false, 共 11 个独立 flag
...
// - test helper 有 8 个 per-flag setter + 1 个全局 enableForTest / resetForTest
...
class FeatureFlags {
  ...
  /// 默认 false (v0.28 真接 productId 时翻 true)。
  ...
  // ====== Per-flag test setter (v0.27 R67 新增, R93 阶段 2 扩到 8 个) ======
  ...
  /// 仅供 test 使用 — 临时把全部 8 个 flag 翻成 enable,跑测试期间走真实业务。
  ///
  /// 等价于:
  ...
  /// 仅供 test 使用 — 把 8 个 flag 全部清空 override,回到 prod 默认值。
  @visibleForTesting
