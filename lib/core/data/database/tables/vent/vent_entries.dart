...
/// 树洞表（v0.15 Round 18, v0.21 Round 22 文字加密, v0.30 R92 contentText DROP）
///
/// 私密倾诉空间，**完全独立于情绪日记**：
/// - 情绪日记：量化跟踪，进趋势页
/// - 树洞：纯倾诉 / 宣泄，**不进任何分析**
...
/// 每次读取 mapper 自动 decrypt。
///
/// v0.30 R92 (audit-fixes): DROP `contentText` TEXT 列 (PIPL §28 泄露风险)
/// - v8→v9 migration (R21) 已把 contentText 一次性加密写回 contentTextEnc
/// - 之后 R22-R91 用户升级仍有 contentText (明文) + contentTextEnc (加密) 双份
/// - 设备 root / 备份偷走 → 字段级明文泄露违反 PIPL §28
/// - R92 schemaVersion 18→19 DROP 删列, 一次性清理
///
