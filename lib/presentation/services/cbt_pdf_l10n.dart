...
// 10 个 getter 委托给 interface, caller 一行构造:
...
/// [CbtPdfL10n] 的 AppLocalizations 实现 (10 getter 委托)
class AppLocalizationsCbtPdfL10n implements CbtPdfL10n {
  ...
  @override
  String get moodCbtSectionAutomaticThought => l10n.moodCbtSectionAutomaticThought;

  @override
  String get moodCbtSectionEvidenceFor => l10n.moodCbtSectionEvidenceFor;

  @override
  String get moodCbtSectionEvidenceAgainst => l10n.moodCbtSectionEvidenceAgainst;
