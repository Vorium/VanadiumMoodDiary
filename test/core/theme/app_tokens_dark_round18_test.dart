...
void main() {
  ...
  testWidgets('P1-22 a11y: light mode text contrast >= 4.5:1',
      (tester) async {
    late Color surface;
    ...
    expect(secondaryRatio, greaterThanOrEqualTo(3.0),
        reason: 'textSecondary vs surface 对比度 $secondaryRatio 应该 >= 3.0 (大字体 AA)');
  });

  testWidgets('P1-22 a11y: dark mode text contrast >= 4.5:1',
      (tester) async {
    late Color surface;
    late Color textPrimary;
    late Color textSecondary;
