...
void main() {
  ...
  group('SectionHeader (R8b 3 cases)', () {
    // ===== 1. 基础 (改 1 老 test 期望): 字号 11 + w500 + textHint =====
    testWidgets('1. 基础: 字号 11 (fontSizeCaptionSm) + w500 + textHint (R8b 改老期望)',
        (tester) async {
      ...
      expect(style.fontSize, AppTokens.fontSizeCaptionSm, // 11
      ...
      expect(style.color, AppTokens.textHintColor(ctx),
    ...
    testWidgets('3. letterSpacing: ALL CAPS=0.6 / 默认=0 (跟随 isAllCaps)',
      ...
      expect(allCapsStyle.letterSpacing, 0.6,
      ...
      expect(normalStyle.letterSpacing, 0,
