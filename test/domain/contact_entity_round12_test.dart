...
void main() {
  group('ContactToEntity (Drift → Entity)', () {
    test('基础字段正确映射', () {
      final row = _driftRow(id: 7, name: '爸爸', phone: '13900139000', sortOrder: 1);
  ...
  group('ContactEntityToDrift (Entity → row / Companion)', () {
    ...
    test('toCompanion 默认 sortOrder=0 isActive=true', () {
      final e = ContactEntity(id: 0, name: 'X', phone: '13800138000');
  ...
  group('Round trip (Drift → Entity → Drift)', () {
    test('完整数据无丢失', () {
      final original = _driftRow(id: 12, name: '医生', phone: '13600136000', sortOrder: 3);
  ...
  group('业务方法', () {
    test('active == isActive', () {
      expect(ContactEntity(id: 1, name: 'A', phone: '13800138000', isActive: true).active, isTrue);
      expect(ContactEntity(id: 1, name: 'A', phone: '13800138000', isActive: false).active, isFalse);
    });

    test('isValidPhone 11 位数字通过', () {
      final c = ContactEntity(id: 1, name: 'X', phone: '13800138000');
      expect(c.isValidPhone, isTrue);
    });

    test('isValidPhone +86 前缀通过', () {
      final c = ContactEntity(id: 1, name: 'X', phone: '+8613800138000');
      expect(c.isValidPhone, isTrue);
    });

    test('isValidPhone 非数字 / 长度错', () {
      expect(ContactEntity(id: 1, name: 'X', phone: '123').isValidPhone, isFalse);
      expect(ContactEntity(id: 1, name: 'X', phone: '1380013800a').isValidPhone, isFalse);
      expect(ContactEntity(id: 1, name: 'X', phone: '138001380000').isValidPhone, isFalse);
    });

    test('bySortOrder 静态比较器', () {
      final a = ContactEntity(id: 1, name: 'A', phone: '13800138000', sortOrder: 2);
      final b = ContactEntity(id: 2, name: 'B', phone: '13800138001', sortOrder: 1);
      final c = ContactEntity(id: 3, name: 'C', phone: '13800138002', sortOrder: 3);
    ...
    test('copyWith 基础字段', () {
      final original = ContactEntity(id: 1, name: 'A', phone: '13800138000');
    ...
    test('copyWith isActive', () {
      final original = ContactEntity(id: 1, name: 'A', phone: '13800138000', isActive: true);
  ...
  group('等值', () {
    test('== hashCode 字段全等才相等', () {
      final a = ContactEntity(id: 1, name: 'A', phone: '13800138000', sortOrder: 0);
      final b = ContactEntity(id: 1, name: 'A', phone: '13800138000', sortOrder: 0);
      final c = ContactEntity(id: 1, name: 'B', phone: '13800138000', sortOrder: 0);
      expect(a, equals(b));
