...
- **联系邮箱:privacy@chroniccare.app**
  用户可通过 **App 内 设置 → 法律与隐私** 页面反馈问题
- 隐私 / PIPL 投诉:**privacy@chroniccare.app**
...
| v0.30 R101 | 2026-08-07 | 联系方式 + 定稿 | 联系方式邮箱改为 privacy@chroniccare.app; 删"草稿"标注; "8元买断"改为"未来版本"; 失联通知描述改为"紧急联系人预存储" |
