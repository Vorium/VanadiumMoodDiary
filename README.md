...
> 我今天吃了药 · 精神心理患者吃药打卡 + 失联通知

**v1.0.0+146**（首个正式版, 2026-08-14）· Flutter 3.41.9 · 本地加密零云端
...
- 情绪日记（5 档情绪 + 影响因素 + 语音）
- 树洞（私密倾诉空间）：文字 / 语音 / 混排，完全独立不参与任何分析
...
- 失联通知（连续 N 天没打卡 → SMS 紧急联系人）
- 国产 ROM 适配：设置页通知自检卡 + 小米/华为/OPPO/vivo 等 7 品牌引导

### 报告与分析
- 主页打卡趋势 + 趋势页（30 天热力图 + 柱状图 + 评估折线）
- 依从性日历（医生视角）+ 评估严重度分级
...
# 22 个守门员（架构纯度 / i18n / 锁屏 PII / 合规 / 覆盖率等）
