...
const replacements = <Replacement>[
  ...
  Replacement('getLatestAssessmentTimestamp', 'checkInDao.getLatestAssessmentTimestamp'),
  Replacement('insertCheckIn', 'checkInDao.insert'),
  Replacement('watchMedications', 'medicationDao.watchActive'),
  Replacement('watchAllMedicationsIncludingInactive', 'medicationDao.watchAllIncludingInactive'),
